...
<div class="wrapper">
    <main class="main">
        <section class="zero">
            <img class="zero__gradient" src="./src/gradient.svg" alt="Градиент" />
            <div class="container">
                <div class="zero__body">
                    ...
                    <p class="zero__sub">или реинтегрируй текущий</p>
                    <h4 class="zero__business">MYFORCE BUSINESS</h4>
                    <p class="zero__def">— это программа реинтеграции действующего бизнеса к стандартам конкурентов,
                        или запуск нового проекта с нуля с использованием налоговых льгот и гос.финансирования по ФЗ № 46</p>
                    <div class="zero__buttons">
                        <a href="pages/quiz.php" class="btn__pink popup-btn">Узнать подходит ли бизнес к закону ФЗ№46
        ...
        <section class="know">
            <div class="container">
                <div class="know__body">
                    <img class="know__img1" src="./src/know-pattern.svg" alt="Многогранник">
                    <img class="know__img2" src="./src/know-pattern.svg" alt="Многогранник">
                    <img class="know__img3" src="./src/know-pattern.svg" alt="Многогранник">
                    <img class="know__img4" src="./src/know-pattern.svg" alt="Многогранник">
                    <h5 class="know__title">Узнай, распространяется ли <span style="font-weight: 600;">ФЗ №46</span> от 8 марта 2022 года на твой бизнес</h5>
                    <a href="pages/quiz.php" class="btn__pink">Узнать подходит ли бизнес к закону ФЗ№46
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11" cy="11" r="10.5" stroke="white"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M6.1875 10.3125C6.00516 10.3125 5.8303 10.3849 5.70136 10.5139C5.57243 10.6428 5.5 10.8177 5.5 11C5.5 11.1824 5.57243 11.3572 5.70136 11.4862C5.8303 11.6151 6.00516 11.6875 6.1875 11.6875H14.1529L11.2007 14.6383C11.1368 14.7022 11.0861 14.7781 11.0515 14.8616C11.0169 14.9451 10.9991 15.0346 10.9991 15.125C10.9991 15.2154 11.0169 15.3049 11.0515 15.3884C11.0861 15.472 11.1368 15.5478 11.2007 15.6118C11.2647 15.6757 11.3406 15.7264 11.4241 15.761C11.5076 15.7956 11.5971 15.8134 11.6875 15.8134C11.7779 15.8134 11.8674 15.7956 11.9509 15.761C12.0344 15.7264 12.1103 15.6757 12.1742 15.6118L16.2992 11.4868C16.3633 11.4229 16.4141 11.347 16.4487 11.2635C16.4834 11.18 16.5012 11.0904 16.5012 11C16.5012 10.9096 16.4834 10.82 16.4487 10.7365C16.4141 10.653 16.3633 10.5771 16.2992 10.5133L12.1742 6.38826C12.1103 6.32434 12.0344 6.27364 11.9509 6.23904C11.8674 6.20445 11.7779 6.18665 11.6875 6.18665C11.5971 6.18665 11.5076 6.20445 11.4241 6.23904C11.3406 6.27364 11.2647 6.32434 11.2007 6.38826C11.1368 6.45219 11.0861 6.52807 11.0515 6.61159C11.0169 6.6951 10.9991 6.78462 10.9991 6.87501C10.9991 6.96541 11.0169 7.05492 11.0515 7.13844C11.0861 7.22196 11.1368 7.29784 11.2007 7.36176L14.1529 10.3125H6.1875Z" fill="white"/>
                        </svg>
        ...
        <section class="ask">
            <div class="container">
                <div class="count blue">
                    <div class="dash__black"></div>
                    <p class="count__num">07</p>
                </div>
                <h3 class="title black">Часто задаваемые вопросы</h3>

                <div class="ask__body">
                    <div class="ask__left">
                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Сколько проектов вы готовы взять для реализации в одно время?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Наша нагрузку определяется степенью сложности проектов, так как мы обладаем, пусть и большим, но лимитированным количество ресурсов (экспертов, специалистов, консультантов). Для уточнения данной информации лучше обратиться за консультацией к нашему менеджеру.</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Как давно  MYFORCE BUSINESS на рынке?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Проект MYFORCE BUSINESS  запущем 15.03.2022 года в связи с принятием ФЗ №46 от 8 марта 2022 года. Компания MYFORCE работает на рынке консалтинга с 2015 года, а опыт работы некоторых наших специалистов достигает 20-25 лет!</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Что если мой бизнес подходит по ФЗ №46 от 8 марта 2022?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">В данном случае вы сможете получить льготное кредитование, пониженную процентную ставку, или принять участие в гос. финансирование деятельности (уточнить дополнительно), а также получить комплекс мероприятий от MYFORCE BUSINESS с частичной компенсацией расходов.</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Вы можете дать инвестиции для моего бизнеса?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Мы не инвестиционная, не кредитная, и не финансовая компания - мы не оказываем услуги финансирования бизнеса, и не привлекаем свои средства в финансирование вашего проекта. Однако вопросы инвестиций мы умеем и знаем как решать. Через нашу экосистему вы легко сможете найти инвестора в свой проект, или посредника по льготному кредитованию бизнеса!</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Что означает «частичная компенсация расходов» от MYFORCE?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">В процессе подготовки предложения для вас, наши специалисты составляют смету по внедрению улучшений в ваш бизнес. Данная смета подразумевает расходы на ее реализацию. Часть данных расходов покрывается за счет бюджетов MYFORCE (за счет недополученной выгоды или за счет снижения себестоимости услуги) или за счет партнерских скидок в экосистеме. </p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">С кем я работаю, если начинаю сотрудничать с MYFORCE</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">В-первую очередь, вы коммуницируете со специалистами MYFORCE, а также с экспертами из нашей экосистемы. Договор подразумевает привлечение проверенных субподрядчиков, ответственность за их работу несем мы на оговоренных условиях. В данный момент в нашей экосистеме насчитывается более 100 партнеров и экспертов (от Bitrix24 и Билайн, до СКБ Контур и системы Правовед).</p>
                        </div>
                    </div>

                    <div class="ask__rihgt">

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Что если мой бизнес не подходит по ФЗ №46 от 8 марта 2022</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Тогда вы сможете получить от MYFORCE BUSINESS персональное предложение для решения своих проблем бизнеса, или по запуску нового проекта!</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">MYFORCE BUSINESS — это платная услуга?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Это не услуга, это набор мероприятий, которые нацелены на изучение, реинтеграцию, и оптимизацию вашего действующего или нового бизнеса. В процессе реализации мероприятий вам будут предложены варианты, которые помогут сделать ваш бизнес более эффективным и прибыльным. Реализация предложенных вариантов будет требовать вложения (инвестиций, или компенсации расходов на реализацию), которые частично сможет покрыть MYFORCE BUSINESS.</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Зачем заключать договор на программу MYFORCE BUSINESS?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Мы стремимся сделать бизнес в России прозрачным, а значит и сами должны на 100% соблюдать законодательство РФ. Мы заключаем договор с вами для определения мероприятий по улучшению вашего бизнеса, который: а) Гарантирует для вас качество выполненных мероприятий, б) Гарантирует для нас ваши добросовестные мотивы. Договор полностью прозрачный, и в-первую очередь, дает вам понимаем всех работ и мероприятий, которые вы получите по программе MYFORCE BUSINESS.</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Вы даете какие-либо гарантии?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Гарантии могут быть даны на поставку товара или услуги, или же на их качество исполнения. Мы даем гарантии на реализацию всех мероприятий строго в тех рамках, которые были оговорены с вами, а также на бизнес-показатели, в которых мы 100% можем быть уверены. Все гарантии, если они возможны, всегда указываются в договоре, как его часть.</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Я могу отказаться от MYFORCE BUSINESS в процессе реализации проекта?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Конечно, вы можете выйти из участников договора в любое время на оговоренных условиях. Мы не стремимся навязать вам наши возможности, наоборот, мы хотим, чтобы вы увидели в них свое будущее!</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Вы выдаете кредиты для бизнеса?</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Нет, мы не финансовая организация, и не выдает кредиты для бизнеса, или любые другие виды займов. Мы занимаемся бизнес-консалтингом, посредничеством, а также бизнес-оптимизацией в различных сферах (от HR и отдела продаж, до IT и маркетинга).</p>
                        </div>

                        <div class="ask__item">
                            <div class="ask__question">
                                <p class="ask__question-txt">Что такое экосистема MYFORCE</p>
                                <div class="ask__arrow"></div>
                            </div>
                            <p class="ask__answer">Это бизнес-сообщество, в которое входят все передовые IT и маркетинговые компании РФ и СНГ, эксперты по продажам и финансам, HR специалисты, специалисты по внешнему управлению, и многие другие, кто готов делится своим опытом и знаниями для оптимизации вашего бизнеса. Деятельность MYFORCE очень легко объяснить - мы изучаем вашу проблему, находим специалиста, и несет ответственность за его работу! На выходе вы получаете оптимизированный бизнес, а мы еще одного эксперта в нашей экосистеме.</p>
                        </div>
                    </div>
                </div>
            </div>
